...
const Editor = ({
    ...
    // React ref objects are persistent and, unlike regular values (like props or state), they don’t cause re-renders when their .current property is updated.
    ...
    useEffect(() => {
        ...
        // Focus on the editor when page is loaded so user can start typing
        ...
        // Clean up when the component unmounts (before rerendering)
        return () => {
            // turn of the listener
            quill.off(Quill.events.TEXT_CHANGE)
            if (container) {
                // setting innerHTML to an empty string 
                // because of the previous dynamically created div
                container.innerHTML = ""
            }
            if (quillRef.current) {
